...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['submit'])) {
        ...
        // Query Insert Data
        $sql = "INSERT INTO vendor (id_vendor, nama) VALUES ('$id_vendor', '$nama')";
    ...
    if (isset($_POST['update'])) {
        ...
        // Query Update Data
        $sql = "UPDATE vendor SET nama='$nama' WHERE id_vendor='$id_vendor'";
    ...
    <div class="main-content">
        ...
        <div class="form-container">
            ...
            <form action="vendor.php" method="POST">
                ...
                <div class="form-group">
                    <button type="submit" name="submit">Tambah Vendor</button>
                </div>
            </form>
        </div>
        ...
        <div class="table-container">
            <table>
                ...
                <tbody>
                        ...
                        <td>
                            <div class="action-buttons">
                                ...
                                <form action="vendor.php" method="POST">
                                    ...
                                    <button type="button" class="edit-button" onclick="openEditModal('<?= $row['id_vendor']; ?>', '<?= $row['nama']; ?>')">
                                        <i class="fas fa-edit"></i> Edit
                                    </button>
                                </form>
                                <!-- Delete Button -->
                                <form action="vendor.php" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?');">
                                    <input type="hidden" name="id_vendor" value="<?= $row['id_vendor']; ?>">
                    ...
                    ?>
                    <tr>
                        <td colspan="3">Tidak ada data jurusan ditemukan.</td>
                    </tr>
                    <?php
                    endif;
    ...
    <div id="editModal" style="display: none;">
        <div style="position: fixed; top:0; left:0; width:100%; height:100%; background-color: rgba(0,0,0,0.5);">
            <div style="background-color: #fff; width: 500px; margin: 100px auto; padding: 30px; border-radius: 6px; position: relative;">
                ...
                <form action="vendor.php" method="POST">
                    <div class="form-group">
                        <label for="edit_id_jurusan">ID Vendor </label>
                        <input type="text" id="edit_id_jurusan" name="id_vendor" readonly>
                    </div>
                    <div class="form-group">
                        <label for="edit_nama_jurusan">Nama Vendor</label>
                        <input type="text" id="edit_nama_jurusan" name="nama" required>
                    </div>
                    <div class="form-group">
